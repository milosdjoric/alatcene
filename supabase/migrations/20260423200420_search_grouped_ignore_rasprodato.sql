-- search_grouped: za min_cena i max_cena ignoriši RASPRODATO ponude
-- kad god grupa ima bar jednu NA_STANJU alternativu. Ako su sve ponude
-- rasprodate, fallback na apsolutni MIN/MAX da grupa ostane vidljiva.
          ...
          'offers', (
            SELECT COALESCE(json_agg(
              json_build_object(
                ...
                CASE WHEN f.dostupnost = 'NA_STANJU' THEN 0 ELSE 1 END ASC,
                f.cena ASC
            ), '[]'::json)
            FROM _filtered f

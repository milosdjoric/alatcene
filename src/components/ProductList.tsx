      ...
      {products.map((product) => {
        ...
        return (
          <a
            ...
            className={`group flex items-center gap-4 bg-[#16181d] border border-[#2a2d35] px-4 py-3 transition-all duration-200 hover:border-[#c8e64a]/40 cursor-pointer ${outOfStock ? "opacity-40" : ""}`}
          >
            ...
            {product.popust_procenat && product.popust_procenat >= 10 && (
              <span className="flex-shrink-0 bg-[#c8e64a] text-[#0c0d10] text-[11px] font-bold px-2 py-0.5">
            ...
            <svg className="h-4 w-4 text-[#2a2d35] group-hover:text-[#c8e64a] flex-shrink-0 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">

    ...
    <>
      ...
      <div className="lg:hidden mb-4">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 border border-[#2a2d35] bg-[#16181d] text-sm text-[#8b8f9a] hover:border-[#c8e64a]/40 transition-colors cursor-pointer"
        >
